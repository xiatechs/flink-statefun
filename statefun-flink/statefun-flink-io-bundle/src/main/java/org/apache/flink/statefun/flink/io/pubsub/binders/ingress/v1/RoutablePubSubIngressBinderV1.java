...
package org.apache.flink.statefun.flink.io.pubsub.binders.ingress.v1;
...
import org.apache.flink.statefun.flink.io.kinesis.binders.ingress.v1.RoutableKinesisIngressSpec;
 ...
 * details.
 */
final class RoutablePubSubIngressBinderV1 implements ComponentBinder {

  private static final ObjectMapper SPEC_OBJ_MAPPER = StateFunObjectMapper.create();

  static final RoutablePubSubIngressBinderV1 INSTANCE = new RoutablePubSubIngressBinderV1();

  static final TypeName KIND_TYPE = TypeName.parseFrom("io.statefun.pubsub.v1/ingress");

  private RoutablePubSubIngressBinderV1() {}
