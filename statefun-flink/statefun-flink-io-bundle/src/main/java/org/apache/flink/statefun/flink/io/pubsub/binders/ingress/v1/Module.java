...
import org.apache.flink.statefun.flink.io.pubsub.binders.ingress.v1.RoutablePubSubIngressBinderV1;
...
public final class Module implements ExtensionModule {
    ...
    public void configure(Map<String, String> globalConfigurations, Binder universeBinder) {
        universeBinder.bindExtension(
                RoutablePubSubIngressBinderV1.KIND_TYPE, RoutablePubSubIngressBinderV1.INSTANCE);
    }
}
